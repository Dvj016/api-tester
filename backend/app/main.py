...
app.add_middleware(
    ...
    allow_headers=["Content-Type", "Accept", "Authorization", "Cache-Control", "Pragma", "Expires"],  # Include cache headers
    expose_headers=["Cache-Control", "Pragma", "Expires"],  # Expose cache headers to frontend
